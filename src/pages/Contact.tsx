            ...
            <div className="bg-white rounded-lg shadow-md p-6 space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">123 Real Estate Ave, New York, NY 10001</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+2348102525792</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">alagbeolalekan1000@gmail.com</p>
                </div>
              </div>
            </div>
          </div>
